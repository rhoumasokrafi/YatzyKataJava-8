...
public class YatzyTest {
		...
		public void Validate_number_Of_Dice() throws InvalidDicesException,NullPointerException{
			//given
	        //when
		...
		@Test(expected = com.yatzy.kata.refactoring.InvalidDicesException.class)
	    public void Validate_Value_Of_Dice() throws InvalidDicesException,NullPointerException{
	        //given
	        //when
